...
final socketConnectionProvider = FutureProvider.autoDispose<void>((ref) async {
  try {
...
// All chats provider
final allChatsProvider = FutureProvider.autoDispose<List<ChatModel>>((
  ref,
) async {
...
final merchantChatProvider =
    FutureProvider.family<ChatModel, Map<String, String>>((ref, params) async {
      final useCase = ref.watch(chatUseCaseProvider);
      return await useCase.getOrCreateMerchantChat(
        params['merchantId']!,
        params['homelessId']!,
      );
    });
